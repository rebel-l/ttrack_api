...
import (
	...
	"github.com/rebel-l/ttrack_api/endpoint/publicholiday"
...
func initCustomRoutes() error {
	...
	*/
	...
	if err := publicholiday.Init(svc, db); err != nil {
		return fmt.Errorf("failed to init the publicholiday endpoints: %w", err)
	}
