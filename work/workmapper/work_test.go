...
func TestMapper_Load(t *testing.T) {
    ...
    testCases := []struct {
        ...
        { 
            name:     "success",
            prepare: &workmodel.Work{
        Start: "CKWnY3MGiwdgYUKapikEHEqCsQS1a384SarFuupVL",
        Stop: ,
},
            expected: &workmodel.Work{
        Start: "CKWnY3MGiwdgYUKapikEHEqCsQS1a384SarFuupVL",
...
func TestMapper_Save(t *testing.T) {
    ...
    testCases := []struct {
        ...
        { 
            ...
            actual:   &workmodel.Work{
        Start: "G3YeeR095Zc79UqAWwBaOwUJ0mDKCgQXXPuRaaKoLjTL7v",
        Stop: ,
},
            expected: &workmodel.Work{
        Start: "G3YeeR095Zc79UqAWwBaOwUJ0mDKCgQXXPuRaaKoLjTL7v",
        ...
        Start: "TLJKDzXASaYUxnDKppHJFamYQi1Kdm6ANHDhWKquV0SDCerie",
        Stop: ,
},
